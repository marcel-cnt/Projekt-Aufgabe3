...
\renewcommand{\cftsecpagefont} {    Seite }  
\renewcommand{\cftsubsecpagefont}  {    Seite }
...
\begin{figure}[h]
\begin{center}
\includegraphics[width = 8.5 cm, height = 3.9 cm]{./../diagram/classes_files3.pdf}\\
\scriptsize\bf\centering Abbildung 1: \normalfont Darstellung der Klassenbeziehungen.\normalsize\\
\end{center}
\end{figure}
